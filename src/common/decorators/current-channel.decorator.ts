...
/**
 * Decorator to inject the interaction.channel object into a method parameter.
 */
export function CurrentChannel(): ParameterDecorator {
    return (target: object, propertyKey: string | symbol | undefined, parameterIndex: number) => {
        ...
        metadata.push({
            type: DiscordParamType.CURRENT_CHANNEL,
