...
/**
 * Decorator to inject the interaction.member object into a method parameter.
 */
export function CurrentMember(): ParameterDecorator {
    return (target: object, propertyKey: string | symbol | undefined, parameterIndex: number) => {
        ...
        metadata.push({
            type: DiscordParamType.CURRENT_MEMBER,
